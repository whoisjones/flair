semantic_label_name_map = {
    ...
    "bc2gm_corpus": {"ner_tags_short": {
        "O": "outside",
        "GENE": "gene",
    }, "ner_tags_long": {
        "O": "outside",
        "GENE": "genes such as BRCA1 or TP53",
    }},
    "ncbi_disease": {"ner_tags_short": {
        "O": "outside",
        "Disease": "disease",
    }, "ner_tags_long": {
        "O": "outside",
        "Disease": "diseases such as cancer, diabetes, or pandemics",
    }},
    "chembenchmark": {"ner_tags_short": {
        "O": "outside",
        "ADDITIVE": "additive",
        "CATHODE_MATERIAL": "cathode material",
        "COATING_MATERIAL": "coating material",
        ...
        "O": "outside",
        "ADDITIVE": "additives such as ionic liquids or surfactants",
        "CATHODE_MATERIAL": "cathode material such as lithium cobalt oxide or lithium iron phosphate",
        "COATING_MATERIAL": "coating material such as carbon or graphene",
        "COATING_METHOD": "coating method is the method used to coat the cathode material",
        "OLEFIN": "olefin is a hydrocarbon containing a double bond",
        "PRE_CATALYST": "pre catalyst is a catalyst that is activated by a chemical reaction",
        "SOLVENT": "solvent which is the basis of a solution",
        "SUPPORT": "support materials are used to support the catalyst",
    }},
